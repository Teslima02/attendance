defmodule Attendance.Accounts.Admin do
  use Ecto.Schema
  ...
  schema "admins" do
    ...
    field :account_type, :string, default: "admin"
  ...
  def registration_changeset(admin, attrs, opts \\ []) do
    admin
    |> cast(attrs, [:first_name, :middle_name, :last_name, :disabled, :email, :password])
    |> validate_email()
  ...
  """
  def valid_password?(%Attendance.Accounts.Admin{hashed_password: hashed_password}, password)

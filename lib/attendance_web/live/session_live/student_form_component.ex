defmodule AttendanceWeb.SessionLive.StudentFormComponent do
  ...
  defp save_student(socket, :edit_student, student_params) do
  ...
  # defp save_student(socket, :new_student, student_params) do

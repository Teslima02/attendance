defmodule AttendanceWeb.AdminAuthTest do
  use AttendanceWeb.ConnCase, async: true

  alias Attendance.Accounts
  alias AttendanceWeb.AdminAuth
  import Attendance.AccountsFixtures

  @remember_me_cookie "_attendance_web_admin_remember_me"
